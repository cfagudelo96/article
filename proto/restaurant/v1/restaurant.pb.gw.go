...
func RegisterRestaurantServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RestaurantServiceServer) error {
	...
	mux.Handle("POST", pattern_RestaurantService_CreateRestaurant_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/restaurant.v1.RestaurantService/CreateRestaurant", runtime.WithHTTPPathPattern("/api/v1/restaurants"))
		if err != nil {
		...
		forward_RestaurantService_CreateRestaurant_0(annotatedContext, mux, outboundMarshaler, w, req, response_RestaurantService_CreateRestaurant_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterRestaurantServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RestaurantServiceClient) error {
	...
	mux.Handle("POST", pattern_RestaurantService_CreateRestaurant_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/restaurant.v1.RestaurantService/CreateRestaurant", runtime.WithHTTPPathPattern("/api/v1/restaurants"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_RestaurantService_CreateRestaurant_0 struct {
	proto.Message
}

func (m response_RestaurantService_CreateRestaurant_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*CreateRestaurantResponse)
	return response.Restaurant
}

var (
	pattern_RestaurantService_CreateRestaurant_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "restaurants"}, ""))
)
