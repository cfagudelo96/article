...
/*
Package reservationv1 is a reverse proxy.
...
func RegisterReservationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReservationServiceServer) error {
	...
	mux.Handle("POST", pattern_ReservationService_CreateReservation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/reservation.v1.ReservationService/CreateReservation", runtime.WithHTTPPathPattern("/api/v1/reservation"))
		if err != nil {
		...
		forward_ReservationService_CreateReservation_0(annotatedContext, mux, outboundMarshaler, w, req, response_ReservationService_CreateReservation_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterReservationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReservationServiceClient) error {
	...
	mux.Handle("POST", pattern_ReservationService_CreateReservation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/reservation.v1.ReservationService/CreateReservation", runtime.WithHTTPPathPattern("/api/v1/reservation"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_ReservationService_CreateReservation_0 struct {
	proto.Message
}

func (m response_ReservationService_CreateReservation_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*CreateReservationResponse)
	return response.Reservation
}

var (
	pattern_ReservationService_CreateReservation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "reservation"}, ""))
)
